  ...
  return (
    <div className="min-h-screen bg-white text-[#111111]">
      ...
      <main className="mx-auto max-w-4xl px-6 py-16">
        ...
        <h1 className="mt-4 font-serif t-display">Privacy Policy</h1>
        ...
        <div className="prose prose-zinc mt-12 max-w-none text-[17px] leading-8">
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">1. Who We Are</h2>
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">2. Information We Collect</h2>
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">3. How We Use Your Information</h2>
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">4. How We Share Your Information</h2>
          <p className="mt-4 text-zinc-700">
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">5. Cookies</h2>
          <p className="mt-4 text-zinc-700">
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">6. Data Retention</h2>
          <p className="mt-4 text-zinc-700">
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">7. Your Rights</h2>
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">8. Security</h2>
          <p className="mt-4 text-zinc-700">
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">9. Third-Party Links</h2>
          <p className="mt-4 text-zinc-700">
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">10. Changes to This Policy</h2>
          <p className="mt-4 text-zinc-700">
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">11. Contact</h2>
          <p className="mt-4 text-zinc-700">
