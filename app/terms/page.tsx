  ...
  return (
    <div className="min-h-screen bg-white text-[#111111]">
      ...
      <main className="mx-auto max-w-4xl px-6 py-16">
        ...
        <h1 className="mt-4 font-serif t-display">Terms &amp; Conditions</h1>
        ...
        <div className="prose prose-zinc mt-12 max-w-none text-[17px] leading-8">
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">1. Acceptance of Terms</h2>
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">2. Services</h2>
          <p className="mt-4 text-zinc-700">
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">3. Use of the Site</h2>
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">4. Intellectual Property</h2>
          <p className="mt-4 text-zinc-700">
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">5. Disclaimer of Warranties</h2>
          <p className="mt-4 text-zinc-700">
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">6. Limitation of Liability</h2>
          <p className="mt-4 text-zinc-700">
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">7. Third-Party Links</h2>
          <p className="mt-4 text-zinc-700">
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">8. Privacy</h2>
          <p className="mt-4 text-zinc-700">
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">9. Modifications</h2>
          <p className="mt-4 text-zinc-700">
          ...
          <h2 className="mt-12 font-serif t-subheading font-normal">10. Governing Law</h2>
          <p className="mt-4 text-zinc-700">
