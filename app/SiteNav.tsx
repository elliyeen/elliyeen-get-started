      ...
      <div className="relative mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 sm:py-5">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="inline-flex min-h-[44px] items-center gap-2 rounded-full bg-[#123A5A] px-6 text-sm font-bold text-[#F5F1E7] shadow-[0_6px_28px_rgba(18,58,90,0.22)] hover:bg-[#0e2d47] transition-colors"
          >
            Get Started
          </a>
