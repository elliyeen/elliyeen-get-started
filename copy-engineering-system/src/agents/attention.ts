...
import type { CopyBrief, AttentionScore } from "../types.js";
import { ATTENTION_PROMPT } from "../prompts/agent_prompts.js";
...
Evaluate this copy through the Attention lens and return your JSON assessment.
  `.trim();
  ...
  const parsed = parseJsonFromResponse<AttentionScore>(text);
  ...
  return {
    ...
    bestHook: parsed.bestHook ?? "",
    headlineOptions: parsed.headlineOptions ?? [],
    patternInterruptIdeas: parsed.patternInterruptIdeas ?? [],
  };
}
