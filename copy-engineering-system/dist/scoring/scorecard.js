 ...
 */
export function buildScorecard(agentResults) {
    const get = (name) => {
        const result = agentResults.find((r) => r.agentName.toLowerCase() === name.toLowerCase());
 ...
 */
export function passesThreshold(scorecard) {
    if (scorecard.overall < PASS_THRESHOLD_OVERALL)
        return false;
    const stages = [
        "attention",
        "curiosity",
    ...
    for (const stage of stages) {
        if (scorecard[stage] < PASS_THRESHOLD_STAGE)
            return false;
    }
    return true;
}
 ...
 */
export function getWeakestStage(scorecard) {
    const stages = [
        "attention",
        "curiosity",
        "understanding",
 ...
 */
export function getStrongestStage(scorecard) {
    const stages = [
        "attention",
        "curiosity",
        "understanding",
 ...
 */
export function formatScorecardTable(scorecard, agentResults) {
    const stages = [
        "attention",
        "curiosity",
        "understanding",
    ...
    const getNote = (stage) => {
        const result = agentResults.find((r) => r.agentName.toLowerCase() === stage.toLowerCase());
        if (!result)
            return "";
 ...
 */
export function getFailingStages(scorecard) {
    const stages = [
        "attention",
        "curiosity",
        "understanding",
