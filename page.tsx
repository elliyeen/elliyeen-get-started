    ...
    <main className="min-h-screen bg-[#f7f4ee] text-[#111111]">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#6d4aff] text-xl font-black text-white">E</div>
          <div className="leading-tight tracking-[0.22em]">
            <div className="text-sm font-bold">ELLIYEEN</div>
            <div className="text-sm font-bold">RESEARCH</div>
          </div>
        </div>

        <div className="hidden items-center gap-10 text-sm font-medium text-zinc-700 md:flex">
          <a href="#solutions" className="flex items-center gap-1 hover:text-black">Solutions <ChevronDown size={14} /></a>
        ...
        <div className="flex items-center gap-3">
          <a href="#login" className="hidden text-sm font-medium md:block">Log in</a>
          <a href="#assessment" className="rounded-xl bg-black px-5 py-3 text-sm font-semibold text-white shadow-sm hover:bg-zinc-800">Get Started</a>
        </div>
      </nav>

      <section className="relative mx-auto grid max-w-7xl items-center gap-12 px-6 pb-16 pt-10 md:grid-cols-2 md:pt-20">
        <div>
          <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-zinc-200 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-wide text-zinc-700 shadow-sm">
            <Sparkles size={14} className="text-[#6d4aff]" /> AI-powered revenue engineering
          </div>
