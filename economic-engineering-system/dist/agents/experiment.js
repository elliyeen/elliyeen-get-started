...
export async function runExperimentAgent(profile, topOpportunity, client) {
    const userMessage = `
BUSINESS PROFILE:
...
Return valid JSON only — no prose outside the JSON block.
  `.trim();
    ...
    return {
        ...
        recommended_first_experiment: parsed.recommended_first_experiment ?? fallbackExperiment,
